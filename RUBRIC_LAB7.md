...
## Tự đánh giá theo RUBRIC_LAB7

| Mục | Điểm tối đa | Điểm tự đánh giá | Nhận xét ngắn |
|---|---:|---:|---|
| A. Chuẩn bị baseline và dữ liệu | 1.5 | 1.5 | Có baseline từ Lab 6, dữ liệu subset 5 lớp rõ ràng, lệnh chạy và artefact đầy đủ. |
| B. Triển khai kỹ thuật nén | 2.5 | 2.5 | Đã triển khai cả 2 hướng nén (Quantization và KD), có mô hình sau nén và chạy thực nghiệm đầy đủ. |
| C. Đánh giá accuracy/macro-F1 | 1.5 | 1.5 | Có đánh giá trước/sau nén, dùng protocol nhất quán. |
| D. Benchmark latency/throughput/model size | 1.5 | 1.5 | Có benchmark latency, throughput, model size; có warmup và repeat. |
| E. Phân tích trade-off | 2.0 | 2.0 | Có so sánh định lượng rõ, có giải thích lựa chọn tham số KD và nêu đánh đổi. |
| F. Tổ chức repo và báo cáo | 1.0 | 1.0 | Repo rõ ràng, báo cáo đầy đủ, quy trình có thể tái lập. |
